...
const Footer = () => {
  return (
    <footer className="pt-16 pb-8 px-4 border-t border-border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="#" className="w-10 h-10 rounded-full glass flex items-center justify-center text-muted-foreground hover:text-foreground transition-colors">
              ...
              <a href="#contact" className="w-10 h-10 rounded-full glass flex items-center justify-center text-muted-foreground hover:text-foreground transition-colors">
          ...
          <div>
            ...
            <div className="space-y-2.5">
              {navLinks.map((link) => (
                <a key={link.label} href={link.href} className="block text-sm text-primary hover:text-foreground transition-colors">
                  {link.label}
                </a>
              ))}
            </div>
